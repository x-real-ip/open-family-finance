export default {
  ...
  text: {
    ...
    cashflowHint: "From salary to the last known destination, for the month you're currently viewing.",
    cashflowDetailLabel: "Detail level",
    cashflowDetailTotals: "Totals",
    cashflowDetailCategories: "Categories",
    cashflowDetailFull: "Full",
    cashflowSharedPot: "Shared pot",
    cashflowBuffer: "Buffer / margin",
    cashflowSalary: "Salary {name}",
    cashflowContribution: "Contribution {name}",
    cashflowLeftover: "Leftover {name}",
    cashflowUnallocated: "Unallocated {name}",
    personalPageHint: "Your own fixed costs, separate from the shared account. Only what you fill in here shows up.",
    ...
    savingsGoalAmountInfo: "This is the monthly contribution as entered under Savings goals in the monthly view. Change the amount there. It's shown here for reference only.",
    subAccountHolder: "Name",
    subAccountHolderPlaceholder: "e.g. Person",
    subAccountBank: "Bank",
    subAccountBankPlaceholder: "e.g. Nordax Bank",
    subAccountIban: "IBAN",
    subAccountIbanPlaceholder: "e.g. DE17...",
    subAccountPlanId: "Plan ID",
    subAccountPlanIdPlaceholder: "e.g. OMA_120...",
    subAccountReference: "Reference",
    subAccountReferencePlaceholder: "e.g. PLAN120329654276",
    subAccountBankDetails: "Bank details",
    subAccountShare: "Share %",
    subAccountShareInfo: "What portion of this savings entry's monthly contribution goes to this account. With more than one account, give each its own percentage (e.g. 50% and 50%).",
    subAccountPreview: "→ your share",
    subAccountInterestRate: "Interest % (annual)",
    subAccountInterestRateInfo: "Optional: this account's annual interest rate. Applied monthly to the running balance (annual rate ÷ 12), so the projection and overview show how much is interest versus your own contributions.",
    ...
    combinedTotal: "Total",
    targetReached: "Target amount reached",
    noSavingsGoals: "No savings entries in the monthly view yet. Add one there to see it here.",
    noSubAccounts: "No accounts added for this goal yet.",
    monthColumn: "Month",
    savingsChartTitle: "Projected growth",
    ...
    copyToPast: "To earlier months",
    copyToFuture: "To later months",
    confirmCopyMonth: "Copy the figures of {month} to {count} other month(s)? Existing data there will be overwritten.",
    copyAll: "All",
    copyNone: "None",
    ...
    customPctLeft: "{pct} left to distribute",
    customPctOver: "{pct} over-allocated",
    addPerson: "Add person",
    confirmRemovePerson: "Remove {name}? This person's income and personal expenses will be removed from every month.",
    ...
    source: "Source",
    nowTag: "now",
    historyLockedHint: "This is a past month. The figures are shown here for reference and are locked.",
    historyUnlockedHint: "This month is unlocked. Changes you make here only apply to this month.",
    historyUnlockBtn: "Unlock to edit",
    historyLockBtn: "Lock again",
