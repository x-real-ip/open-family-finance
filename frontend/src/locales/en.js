export default {
  ...
  text: {
    ...
    checkpointInfo: "The projection's starting point: the actual bank balance in the month you're currently viewing. Everything after this month is projected automatically (start amount + monthly contribution, plus any interest); months before it aren't shown.",
