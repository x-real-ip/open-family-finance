export default {
  ...
  text: {
    ...
    checkpointInfo: "The projection's starting point: enter the month and the actual bank balance as you currently see it at the bank. Everything after this month is projected automatically (checkpoint balance + monthly contribution); months before it aren't shown.",
    checkpointBalance: "Balance in checkpoint month",
