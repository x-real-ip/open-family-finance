export default {
  ...
  text: {
    ...
    checkpointInfo: "Het startpunt van de projectie: het werkelijke banksaldo in de maand die je op dit moment bekijkt. Alles ná deze maand wordt automatisch doorgerekend (startbedrag + inleg per maand, plus eventuele rente); maanden ervoor worden niet getoond.",
