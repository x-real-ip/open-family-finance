export default {
  ...
  text: {
    ...
    cashflowHint: "Van salaris tot de laatst bekende bestemming, voor de maand die je nu bekijkt.",
    cashflowDetailLabel: "Detailniveau",
    cashflowDetailTotals: "Totalen",
    cashflowDetailCategories: "Categorieën",
    cashflowDetailFull: "Volledig",
    cashflowSharedPot: "Gezamenlijke pot",
    cashflowBuffer: "Buffer / marge",
    cashflowSalary: "Salaris {name}",
    cashflowContribution: "Bijdrage {name}",
    cashflowLeftover: "Overschot {name}",
    cashflowUnallocated: "Vrij besteedbaar {name}",
