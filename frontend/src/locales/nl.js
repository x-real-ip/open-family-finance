export default {
  ...
  text: {
    ...
    goalForwardedLabel: "Wordt doorgeboekt naar andere rekening",
    goalForwardedInfo: "Vink dit aan als dit geld na de gezamenlijke rekening nog verder wordt overgeboekt naar een aparte spaarrekening (bijvoorbeeld bij een andere bank). Je kunt dan per bestemming een banksaldo bijhouden en een verwachte opbouw zien. Laat dit uit als het geld gewoon op de gezamenlijke rekening blijft staan.",
