export default {
  ...
  text: {
    ...
    checkpointMonth: "Peilmaand",
    checkpointInfo: "Het startpunt van de projectie: vul de maand en het werkelijke banksaldo in zoals je dat nu bij de bank ziet. Alles ná deze maand wordt automatisch doorgerekend (peilsaldo + inleg per maand); maanden ervoor worden niet getoond.",
    checkpointBalance: "Saldo in peilmaand",
